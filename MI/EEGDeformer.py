...
class Deformer(nn.Module):
    ...
    def __init__(self, *, num_chan, num_time, temporal_kernel, num_kernel=64,
        ...
        :param temporal_kernel: temporal kernel size
        :param num_kernel: number of kernels
        :param num_classes: number of classes
        :param depth: number of transformer layers
        :param heads: number of heads
        :param mlp_dim: mlp hidden size of transformer
        :param dim_head: head size of transformer
    ...
    def change_head(self, num_classes: int) -> None:
        """
        ...
        """
        self.mlp_head = nn.Sequential(
            nn.Linear(self.mlp_head[0].in_features, num_classes),
        )

    def forward_no_head(self, eeg):
        # eeg: (b, chan, time)
